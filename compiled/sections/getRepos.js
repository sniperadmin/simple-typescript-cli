...
exports.askForGhUsername = void 0;
var _ = __importStar(require("lodash"));
var GithubService_1 = require("../services/GithubService");
var inquirer = require('../utils/githubUsername');
exports.askForGhUsername = function () {
    return __awaiter(this, void 0, void 0, function () {
        var credentials, svc;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, inquirer.askGithubUsername()];
                case 1:
                    credentials = _a.sent();
